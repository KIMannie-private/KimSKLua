...
local function update_visiblity()
	...
	ui_set_visible(shots_reference, enabled and table_contains(ui_get(triggers_reference), "1 shots"))
...
local function on_setup_command(cmd)
	...
	if hotkey then
		...
		if (table_contains(triggers, "1 shots") and (shots >= shots_min or shots == -1)) or standing then
