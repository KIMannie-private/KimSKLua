...
local r, g, b = func_rgb_rainbowize(0.1, 1)
		...
		renderer_gradient(0, 0, 3840, 2, g, b, r, a, r, g, b, a, true)
		renderer_gradient(3840, 0, 3840, 2, r, g, b, a, b, r, g, a, true)

		local a_lower = a*0.5
		
		renderer_gradient(0, 2, 3840, 2, g, b, r, a_lower, r, g, b, a_lower, true)
		renderer_gradient(3840, 2, 3840, 2, r, g, b, a_lower, b, r, g, a_lower, true)
