...
local menu = {
    ...
    enabled = ui_new_checkbox("LUA", "A", "Fake Angel"),
    clantags = ui_new_combobox("LUA", "A", "Fake Angel", getMenuItems()),
    text = ui_new_textbox("LUA", "A", "Text"),
    animated = ui_new_checkbox("LUA", "A", "Animated tag"),
    style = ui_new_combobox("LUA", "A", "Animation style", "Default", "Reverse", "Loop", "Classic"),
    speed = ui_new_slider("LUA", "A", "Animation speed", 0, 100, 30, true, "%", 1)
