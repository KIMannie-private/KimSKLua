...
local dormant = ui.new_color_picker("VISUALS", "Effects", "mant color", 0, 255, 251, 255);
local active_text = ui.new_label("VISUALS", "Effects", "Active color");
local active = ui.new_color_picker("VISUALS", "Effects", "Active color", 225, 0, 50, 255);
...
local colors = {
    ...
    GAMESENSE = col_t.new(0, 255, 251, 255)
--125, 220, 238, 200),
};
