...
local officialDataSet = {
    ["Standing"] = {
        ["pitch"] = "Minimal",
        ["yaw"] = "180",
        ["yawValue"] = {0,0,0,0,0,0,0,0,0,120,0,0,0,0,0,0,0,0,0,-87,0,0,0,0,0,0,0,0,0,120,0,0,0,0,0,0,0,0,0,-87,0,0,0,0,0,0,0,0,0,120,0,0,0,0,0,0,0,0,0,-87,0,0,0,0,0,0,0,0,0,120,0,0,0,0,0,0,0,0,0,-87},
        ["jitter"] = "off",
        ["jitterValue"] = {-130},
        ["bodyYaw"] = "Static",
        ["bodyYawValue"] = {0},
    ...
    ["Moving"] = {
        ["pitch"] = "Minimal",
        ["yaw"] = "180",
        ["yawValue"] = {9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17},
        ["jitter"] = "off",
        ["jitterValue"] = {9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17,9,10,11,12,13,14,15,16,17},
        ["bodyYaw"] = "Static",
        ["bodyYawValue"] = {60},
        ["lbyTarget"] = {"Opposite"},
        ["limit"] = {60}
    ...
    ["SlowMotion"] = {
        ...
        ["jitterValue"] = {19},
        ["bodyYaw"] = "Static",
        ["bodyYawValue"] = {-90,-90,-90,-90,-95,-95,-95,-95},
        ["lbyTarget"] = {"Opposite"},
        ["limit"] = {60},
        },
}
...
local AAProcessor = {
    ...
    onTick = function()
        ...
        if(isFacingLeft == true) then
            manual_aa_direction_parm = -80
        end
        if(isFacingRight == true) then
            manual_aa_direction_parm = 60
        end
