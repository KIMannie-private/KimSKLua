...
client.color_log(0, 255, 216, "[gamesense] ♛KIM-Beta.CFG♛")
client.color_log(0, 255, 216, "[gamesense] AA lua V4: 2020/06/06")
client.color_log(0, 255, 216, "[gamesense] CFG Update: 2020/06/06")
client.color_log(0, 255, 0, "[gamesense] For premium&id=6259")
...
require("./♛KIM-Beta♛/KIM/KL- Legit AT")

require("./♛KIM-Beta♛/KIM/KS- Best-LegalAA")
