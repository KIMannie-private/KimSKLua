...
local function handle_paint(ctx)
    ...
    client.draw_indicator(ctx, r, g, b, 255, "")--name goes here
end
...
local function on_paint(c)
    ...
    local r, g, b = func_rgb_rainbowize(0.1, 1)
    client.draw_indicator(ctx, r, g, b, 255, "hits: ", hits)
    client.draw_indicator(ctx, r, g, b, 255, "misses: ", misses)
    client.draw_indicator(ctx, r, g, b, 255, "total: ", total)
    client.draw_indicator(ctx, r, g, b, 255, "percent: ", fixed, "%")
    client.draw_indicator(ctx, r, g, b, 255, "----♛ CFG By KIM ♛----")--name goes here
	end
...
client_set_event_callback("paint", on_paint,handle_paint)
